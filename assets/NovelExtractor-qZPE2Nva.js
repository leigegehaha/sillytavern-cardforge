import{$ as e,A as t,C as n,F as r,M as i,O as a,T as o,a as s,c,d as l,et as ee,f as u,h as d,j as f,l as p,t as te,tt as m,u as ne,x as re}from"./app-CCXcoXgk.js";import{a as h,n as g,o as _}from"./runtime-dom.esm-bundler-D3mTYRXM.js";import{t as ie}from"./card-BwJDmFFr.js";import{t as ae}from"./plugin-vue_export-helper-DKl4mWgK.js";import{t as oe}from"./api-BFZ535eH.js";import{r as v,u as y}from"./npc-checker-BhhnmB1N.js";import{n as b,t as se}from"./json-repair-dNPF_vYh.js";import{t as ce}from"./WorldEntryCard-CuW3GrtR.js";var x=[{key:`character`,label:`角色`,desc:`5 种轨迹（境界/位置/物品/关系/行为模式）`},{key:`eventline`,label:`事件线`,desc:`主线/支线/暗线/伏笔，含起因/经过/结果`},{key:`timeline`,label:`时间线`,desc:`阶段+时间标记+境界状态`},{key:`setting`,label:`设定`,desc:`功法/丹药/地理/势力/世界观常识`},{key:`item_trajectory`,label:`物品轨迹`,desc:`获得章节+消耗章节，不存当前持有`}],S={major_characters:0,minor_characters:15,main_storylines:0,side_storylines_total:10,techniques:10,pills:10,geo_factions:10,worldview_per_subsystem:1},C=[{value:`replace`,label:`替代主角（{{user}} 就是小说主角）`,desc:`适合穿越同人——玩家代入主角`},{value:`npc`,label:`独立角色（主角作为 NPC，{{user}} 是另一个人）`,desc:`适合剧情体验——玩家跟主角互动`}],le=`## 写作铁律（必须严格遵守）
